            ...
            <div class="form-group">
                ...
                <div style="display: flex; gap: 2rem;">
                    <label style="display: flex; align-items: center; gap: 0.5rem; cursor: pointer;">
                        <input type="radio" name="type" value="individual" checked onchange="toggleClientType()">
                        <span>Particulier</span>
                    </label>
                    <label style="display: flex; align-items: center; gap: 0.5rem; cursor: pointer;">
                        <input type="radio" name="type" value="company" onchange="toggleClientType()">
            ...
            <div class="card-body">
                ...
                <div id="company-fields" style="display: none;">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="siret" name="siret" maxlength="14" placeholder="14 chiffres">
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="form-group">
                ...
                <textarea id="notes" name="notes" rows="4" placeholder="Informations complémentaires, préférences..."></textarea>
            </div>
        </div>
    </div>
...
function toggleClientType() {
    ...
    if (type === 'company') {
        ...
        // Ajouter required aux champs particulier
        ...
        // Retirer required des champs entreprise
